...
<div class="container">
	...
	<!-- 검색폼 -->
	<form class="form-inline" name="searchForm" action="memberList.do" method="post">
		...
		<div class="form-group">
		<input type="button" value="검색" onclick="fn_search()" class="form-control">
		</div>
	</form>
	<!-- //검색폼 -->
	
	<p align="right"><input type="button" value="회원가입" class="btn btn-default" onclick="fn_form()"></p>
