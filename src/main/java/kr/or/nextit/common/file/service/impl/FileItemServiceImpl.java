...
public class FileItemServiceImpl implements FileItemService{
	...
	/*private static FileItemServiceImpl instance = new FileItemServiceImpl();
	
	private FileItemServiceImpl() {}
	
	public static FileItemServiceImpl getInstance() {
		if(instance == null) {
			instance = new FileItemServiceImpl();
		}
		return instance;
	}*/
