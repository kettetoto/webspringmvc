...
public class MemberController {
	...
	public Map<String, String> gegSearchType(){
	...
	public String memberInsert(
			//자동 바인딩, @@ModelAttribute 생성과 동시에 Model에 자동으로 넣어줌 
		...
		/*Member member = new Member(); 자동 바인딩 하는 부분 
...
*/		
		...
		if(StringUtils.isBlank(member.getMem_name())) {
			...
			//model.addAttribute("member", member);
			return "member/memberForm";
			//redirect하면 data 날림 모델 data를 계속 인지하고 싶으면 session에 담아야 함 
